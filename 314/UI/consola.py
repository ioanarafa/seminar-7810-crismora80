...
class Consola:
    ...
    def uiAdaugaMasina(self):
        try:
            ...
            nivelConfort = input("Dati nivelul de confort al masinii (standard, ridicat, premium):")
    ...
    def uiModificaMasina(self):
        try:
            ...
            nivelConfort = input("Dati noul nivel de confort al masinii (standard, ridicat, premium) :")
